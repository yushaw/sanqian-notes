...
export function createDemoNotes(): void {
    ...
    content: [
      {
        ...
        content: [
          { type: 'text', text: '这是一款专注于 ' },
          { type: 'text', marks: [{ type: 'highlight' }], text: '沉浸式写作' },
          { type: 'text', text: ' 的笔记应用。查看 ' },
          {
            type: 'text',
            marks: [{ type: 'noteLink', attrs: { noteId: note2Id, noteTitle: '编辑器功能演示' } }],
            text: '编辑器功能演示'
          },
          { type: 'text', text: ' 了解高级功能，或阅读 ' },
          {
            type: 'text',
      ...
      },
      {
        ...
        content: [
          { type: 'paragraph', content: [
            ...
            { type: 'text', text: ' 可以快速插入各种块元素，试试看！' }
          ] }
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'text', text: '、' },
          { type: 'text', marks: [{ type: 'textStyle', attrs: { color: '#ef4444' } }], text: '彩色文字' },
          { type: 'text', text: '、' },
      ...
      },
      {
        ...
        content: [
          { type: 'text', text: '输入 ' },
          { type: 'text', marks: [{ type: 'code' }], text: '/脚注' },
          { type: 'text', text: ' 或按 ' },
          { type: 'text', marks: [{ type: 'code' }], text: '⌘⇧F' },
          { type: 'text', text: ' 插入脚注' },
          { type: 'footnote', attrs: { id: 1, content: '脚注可以添加补充说明，鼠标悬停查看，点击可编辑。' } },
          { type: 'text', text: '，非常适合学术写作。' }
        ]
      },
      {
        type: 'heading',
      ...
      },
      {
        ...
        content: [
          { type: 'text', text: '输入 ' },
          { type: 'text', marks: [{ type: 'code' }], text: '[[' },
          { type: 'text', text: ' 可以创建笔记间的链接，构建你的知识网络：' }
        ]
      },
      {
        type: 'bulletList',
        ...
        content: [
          { type: 'listItem', content: [{ type: 'paragraph', content: [
            { type: 'text', marks: [{ type: 'code' }], text: '[[笔记名]]' },
            { type: 'text', text: ' — 链接到笔记' }
          ] }] },
          { type: 'listItem', content: [{ type: 'paragraph', content: [
            { type: 'text', marks: [{ type: 'code' }], text: '[[笔记名#标题]]' },
            { type: 'text', text: ' — 链接到特定标题' }
          ] }] },
          { type: 'listItem', content: [{ type: 'paragraph', content: [
            { type: 'text', marks: [{ type: 'code' }], text: '[[笔记名#^blockId]]' },
            { type: 'text', text: ' — 链接到特定段落' }
          ] }] }
        ]
      },
      {
        ...
        content: [{ type: 'text', text: '打字机模式' }]
      },
      {
        type: 'paragraph',
        attrs: { blockId: 'tw1' },
        content: [
          { type: 'text', text: '点击工具栏的打字机图标进入 ' },
          { type: 'text', marks: [{ type: 'bold' }], text: '沉浸式写作模式' },
          { type: 'text', text: '：' }
        ]
      },
      {
        ...
        attrs: { blockId: 'tw2' },
        content: [
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '🎨 5 种禅意主题（墨夜、宣纸、竹林、樱花、深海）' }] }] },
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '🎵 5 种环境音（雨声、咖啡厅、海浪、壁炉、森林）' }] }] },
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '⌨️ 打字机音效' }] }] },
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '👁️ 专注模式（淡化非当前段落）' }] }] }
        ]
      },
      {
        type: 'taskList',
        ...
        content: [
          ...
          { type: 'taskItem', attrs: { checked: false }, content: [{ type: 'paragraph', content: [{ type: 'text', text: '尝试输入 / 插入块' }] }] },
          { type: 'taskItem', attrs: { checked: false }, content: [{ type: 'paragraph', content: [{ type: 'text', text: '体验打字机模式' }] }] },
  ...
  const featuresContent = {
    ...
    content: [
      ...
      {
        type: 'callout',
        attrs: { type: 'note', collapsed: false },
        content: [
  ...
  const shortcutsContent = {
    ...
    content: [
      ...
      {
        type: 'callout',
        attrs: { type: 'tip', collapsed: false, blockId: 'tip001' },
        content: [
          { type: 'paragraph', content: [
            { type: 'text', marks: [{ type: 'bold' }], text: '提示：' },
            { type: 'text', text: '这个段落可以被其他笔记引用！语法：' },
            { type: 'text', marks: [{ type: 'code' }], text: '[[快捷键速查表#^tip001]]' }
          ] }
        ]
      },
      {
        type: 'heading',
        attrs: { level: 1, blockId: 'txtfmt' },
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            type: 'tableRow',
            content: [
              { type: 'tableCell', content: [{ type: 'paragraph', content: [{ type: 'text', marks: [{ type: 'code' }], text: '1. 空格' }] }] },
  ...
  insertStmt.run(note1Id, '欢迎使用三千笔记', JSON.stringify(mainContent), null, 0, null, 0, 1, now, now)
  insertStmt.run(note2Id, '编辑器功能演示', JSON.stringify(featuresContent), null, 0, null, 0, 0, now, now)
