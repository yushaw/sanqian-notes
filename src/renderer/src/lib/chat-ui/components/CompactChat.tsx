      ...
      {(() => {
        ...
        const inputElement = (
          <ChatInput
            ...
            textareaClassName={`flex-1 resize-none bg-transparent text-sm leading-normal focus:outline-none ${shouldRenderInputExternally ? 'py-2.5 whitespace-nowrap overflow-x-auto' : 'py-2'} max-h-[120px] text-app-text placeholder:text-app-muted`}
